...
const Landing: React.FC<ILanding> = (props: ILanding) => {
  ...
  return (
    <>
      <h5 style={{ textAlign: 'center', marginBlockStart: '0.66rem', marginBlockEnd: '0.1rem' }}>Questions &amp; Answers</h5>
      <div className="d-flex flex-column justify-content-start align-items-center pt-0 mx-auto border-bottom abouts">
        ...
        <p className="mx-auto">
          ...
          <br />
          That's why we need to register and sign-in.
          <br />
        ...
        <p className="mx-auto">
          Most of the software companies need some kind of software for client support.<br />
        ...
        <p className="mx-auto">
          <ul>
            <li>User sends you an email with the Question</li>
